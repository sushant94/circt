...
public:
  ...
  FirtoolOptions &setEnableModularBTOR2PPMemorySplitting(bool value) {
    enableModularBTOR2PPMemorySplitting = value;
    return *this;
  }
...
LogicalResult populateHWToBTOR2PP(mlir::PassManager &pm,
                                  const FirtoolOptions &opt,
                                  llvm::raw_ostream &os);
