// RUN: circt-opt %s --convert-hw-to-btor2pp=btor2-formal-normalize-regs=true -o - | FileCheck %s --implicit-check-not="output {{.*}}__btor2_formal_shadow__"
...
// CHECK-LABEL: module DirectShadowRegs {
